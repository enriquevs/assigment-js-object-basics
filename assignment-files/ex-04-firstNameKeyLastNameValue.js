...
// ++ YOUR CODE HERE
function firstNameKeyLastNameValue(name1, name2, name3){
  var fullName1 = name1.split(" ");
  var fullName2 = name2.split(" ");
  var fullName3 = name3.split(" ");

  var object = {};
  object[fullName1[0]] = fullName1[1];
  object[fullName2[0]] = fullName2[1];
  object[fullName3[0]] = fullName3[1];
