...
// ++ YOUR CODE HERE
function flipColor(object){ // entra el objeto
  var newObject = object; // crea una variable que la iguala al objeto
  if (newObject.color === "blue"){
    newObject.color = "red"; // si el color en la linea anterior es igual a azul se cambia a rojo
  } else if (newObject.color === "red"){
    newObject.color = "blue"; // si el color en la linea anterior es rojo se cambia a azul
  }
  return newObject; //el return va afuera del if para no interrumpir el ciclo
}
